...
<html>
   <head>
      ...
      <!-- CSS link -->
      <link rel="stylesheet" href="/index/akash_MySQL/12_oct_20/style.css">
      <!-- Titel -->
      <title>Akash Training</title>
      <link rel="icon" href="/index/icon.JPG">
      <!-- JavaScript -->
      <script src="/index/akash_MySQL/12_oct_20/ajaxscript.js"></script>
   </head>
   <body>
      <!-- NavBar -->
         ...
         <div class="col-lg-6">
            ...
            <form class="mt-5">
               ...
               <div class="form-group">
                  ...
                  <select class="form-control" id="state" onchange="myfun(this.value)">
